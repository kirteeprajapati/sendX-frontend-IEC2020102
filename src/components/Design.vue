<template>
  <div class="flex flex-col pt-3 padding-x justify-center">
    <form class="flex justify-end">
      <div
        class="flex leading-6 text-slate-900 placeholder-slate-400 rounded-md ring-1 ring-slate-200 shadow-sm"
      >
        <img
          src="@/assets/icons/graySearch.svg"
          class="mx-2 w-5 flex items-center justify-center"
        />
        <input
          class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 pl-3 pr-3 ring-1 ring-slate-200 shadow-sm"
          type="text"
      ...
      designCardsData2: [
        {
          ...
          inputName: 'radio',
          isChecked: false,
          imageSrc: Images.ModalBackgroundClassic,
          title: 'Modal Background Classic'
        }
      ],
      designCardsData3: [
        {
          ...
          inputName: 'radio',
          isChecked: false,
          imageSrc: Images.ModalLeftImageMordern,
          title: 'Modal Left Image Mordern'
        }
      ],
      designCardsData4: [
        {
          ...
          inputName: 'radio',
          isChecked: false,
          imageSrc: Images.PageTakeoverMordernRetro,
          title: 'Page Takeover Mordern Retro'
        }
      ],
      designCardsData5: [
        {
      ...
      designCardsData7: [
        {
          ...
          inputName: 'radio',
          isChecked: false,
          imageSrc: Images.ModalBackgroundMordern,
          title: 'Modal Background Mordern'
        }
      ],
      designCardsData8: [
        {
          ...
          inputName: 'radio',
          isChecked: false,
          imageSrc: Images.SliderModern,
          title: 'Slider Mordern'
        }
      ]
    }
  }
